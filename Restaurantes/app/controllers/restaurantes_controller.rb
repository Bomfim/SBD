class RestaurantesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @restaurante.update(restaurante_params)
        format.html { redirect_to @restaurante, notice: 'Restaurante foi editado com sucesso.' }
  ...
  def destroy
    @restaurante.destroy
    respond_to do |format|
      format.html { redirect_to restaurantes_url, notice: 'Restaurante foi excluído com sucesso.' }
  ...
  private
    ...
    def restaurante_params
      params.require(:restaurante).permit(:cnpj, :nome, :endereco, :cidade)
    end
end
