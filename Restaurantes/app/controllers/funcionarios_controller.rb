class FuncionariosController < ApplicationController
  ...
  private
    ...
    def funcionario_params
      params.require(:funcionario).permit(:nome, :salario, :endereco, :cpf, :tipo_funcionario, :formacao_gerente, :adicional_garcom, :especializacao_cozinheiro, :cnpj, :restaurante_id)
    end
end
