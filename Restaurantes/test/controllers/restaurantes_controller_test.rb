...
class RestaurantesControllerTest < ActionController::TestCase
  ...
  test "should create restaurante" do
    assert_difference('Restaurante.count') do
      post :create, restaurante: { cidade: @restaurante.cidade, cnpj: @restaurante.cnpj, endereco: @restaurante.endereco, nome: @restaurante.nome }
    end
  ...
  test "should update restaurante" do
    patch :update, id: @restaurante, restaurante: { cidade: @restaurante.cidade, cnpj: @restaurante.cnpj, endereco: @restaurante.endereco, nome: @restaurante.nome }
    assert_redirected_to restaurante_path(assigns(:restaurante))
  end
